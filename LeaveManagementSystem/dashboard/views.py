...
def dashboard_employees_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Trying to create dublicate employees with a single user accounts ',
...
def employee_edit_data(request, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Error Updating accounts', extra_tags='alert alert-warning alert-dismissible show')
...
def leave_creation(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, 'Leave Request Sent,wait for ATA Freight Managers response',
                             extra_tags='alert alert-success alert-dismissible show')
